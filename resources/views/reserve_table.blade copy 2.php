                ...
                <div class="modal-body">
                    <div class="row"> 
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="hidden" class="form-control" id="table_group_1_zone" name="table_group_1_zone" value="1">
                            {{-- <input type="hidden" name="user_id" id="user_id" value="{{ Auth::user()->id }}"> --}}
                    
                        <div class="col-md-12 mb-3"> 
                            <select id="user_id" name="user_id" class="form-control form-control-sm input-rounded" style="width: 100%">
