...
<div class="container">
    {{-- <h3 align="center" style="color: white" class="mt-4">จัดการโต๊ะ</h3>
    <a class="btn btn-outline-warning btn-sm" data-bs-toggle="modal" data-bs-target="#saveModal1" style="color: rgb(241, 94, 8)">เพิ่มโต๊ะ</a>
    <br/> --}}
        ...
        <div class="panel-heading ">
            <div class="row">
                <div class="col-md-2 mt-4 mb-3">
                    <h5 style="color: white" >จัดการโต๊ะ</h5>
                </div>
                <div class="col"></div>
                            ...
                            @foreach ($table_group_1 as $item)
                                <tr >
                                    ...
                                    <td style="color: white">
                                        ...
                                        {!! QrCode::size(40)->generate(asset('order_add/'.$item->table_group_1_name)); !!} 
                                    </td> 
                                    ...
                                    <td style="color: white" width="20%">                                             
                                        ...
                                        <button type="button" class="btn btn-outline-danger" href="javascript:void(0)" onclick="delettable({{ $item->table_group_1_id }})" >
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select id="table_group_1_zone0" name="table_group_1_zone" class="form-control form-control-sm input-rounded" style="width: 100%">
                                            ...
                                            <div class="modal-footer">
                                                {{-- <button id="updateBtn" class="btn btn-primary btn-sm"> --}}
